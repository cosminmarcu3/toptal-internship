const getSiblings = ({ activePage, siblingCount, totalPages, }) => {
    const rightSiblings = [];
    const leftSiblings = [];
    const rightmostSibling = activePage + siblingCount;
    const leftmostSibling = activePage - siblingCount;
    for (let page = activePage + 1; page <= rightmostSibling && page < totalPages; page++) {
...
//# sourceMappingURL=get-siblings.js.map