...
declare type AdjustedSelectProps<M extends boolean> = Omit<SelectProps<number, M>, 'options'>;
/**
 ...
 */
export interface Props<Multiple extends boolean> extends AdjustedSelectProps<Multiple> {
    /** a number of month select starts from. e.g. 5 for May */
    from?: number;
    /** a number of month select ends at. e.g. 11 for November */
    to?: number;
}
export declare const MonthSelect: import("../utils/forward-ref").Component<(<M extends boolean = false>(props: Props<M> & {
