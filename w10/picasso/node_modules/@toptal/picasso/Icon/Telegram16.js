...
const SvgTelegram16 = forwardRef(function SvgTelegram16(props, ref) {
    ...
    return (React.createElement("svg", { viewBox: '0 0 16 16', className: cx(...classNames), style: svgStyle, ref: ref, "data-testid": testId },
        React.createElement("path", { d: 'M8 0C3.58 0 0 3.58 0 8s3.58 8 8 8 8-3.58 8-8-3.58-8-8-8Zm3.929 5.48-1.313 6.188c-.097.438-.358.545-.722.338l-2-1.474-.965.93c-.106.106-.197.196-.403.196l.142-2.035 3.706-3.349c.161-.142-.035-.222-.248-.08l-4.58 2.883-1.975-.616c-.43-.135-.439-.429.09-.635l7.713-2.974c.358-.13.671.087.555.629Z' })));
});
