...
const SvgTeam24 = forwardRef(function SvgTeam24(props, ref) {
    ...
    return (React.createElement("svg", { viewBox: '0 0 24 24', className: cx(...classNames), style: svgStyle, ref: ref, "data-testid": testId },
        React.createElement("path", { d: 'M3.95 16 8 7.388V0h8v7.388L20.056 16H24v8h-8v-4H8v4H0v-8h3.95Zm1.105 0H8v3h8v-3H18.951l-3.768-8H8.817l-3.762 8ZM7 20v-3H1v6h6v-3Zm10-1v4h6v-6h-6v2ZM9 7h6V1H9v6Z' })));
});
