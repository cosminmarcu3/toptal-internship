...
const SvgLanguage16 = forwardRef(function SvgLanguage16(props, ref) {
    ...
    return (React.createElement("svg", { viewBox: '0 0 16 16', className: cx(...classNames), style: svgStyle, ref: ref, "data-testid": testId },
        React.createElement("path", { d: 'm6 12-4 4v-4H0V0h16v12H6Zm-3 1.586L5.586 11H15V1H1v10h2v2.586ZM11.039 9H9.842l-.441-1.152H6.647L6.206 9H5.009l2.358-6.003h1.314L11.039 9ZM9.104 6.921l-1.08-2.862-1.08 2.862h2.16Z' })));
});
