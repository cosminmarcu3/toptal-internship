import { HTMLAttributes, InputHTMLAttributes, ChangeEvent, ReactNode } from 'react';
 ...
 */
export interface SelectProps<T extends ValueType = ValueType, M extends boolean = boolean, V = M extends true ? T[] : T> extends BaseProps, Omit<InputHTMLAttributes<HTMLInputElement>, 'onChange' | 'size' | 'color' | 'value'> {
...
export declare type FocusEventType = (event: React.FocusEvent<HTMLInputElement>) => void;
...
declare type GetRootProps = () => {
    onFocus: FocusEventType;
    onClick: (event: React.MouseEvent<HTMLInputElement>) => void;
    onBlur: FocusEventType;
};
declare type GetInputProps = () => Partial<HTMLAttributes<HTMLInputElement>>;
declare type GetSearchInputProps = () => Partial<HTMLAttributes<HTMLInputElement>>;
