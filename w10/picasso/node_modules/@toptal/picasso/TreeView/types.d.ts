...
export declare type DynamicPointNode = HierarchyPointNode<TreeNodeInterface> & {
...
export declare type DynamicPointLink = {
    source: DynamicPointNode;
    target: DynamicPointNode;
};
export declare type DirectionsType = 'vertical' | 'horizontal';
...
export interface TreeViewPropsBase {
    ...
    renderNode?: (pointNode: HierarchyPointNode<TreeNodeInterface>) => React.ReactNode;
...
export declare type TreeViewVariant = 'normal' | 'compact';
