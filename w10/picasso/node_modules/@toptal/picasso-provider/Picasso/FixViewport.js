...
const FixViewport = () => {
    ...
    const nonPicassoViewportTags = document.querySelectorAll('meta[name="viewport"]:not([data-picasso="true"])');
    if (nonPicassoViewportTags.length > 0) {
        if (!warned) {
            unsafeErrorLog(`PICASSO:
    ...
    return (React.createElement(Helmet, null,
        React.createElement("meta", { name: 'viewport', content: content, "data-picasso": 'true' })));
};
export default FixViewport;
//# sourceMappingURL=FixViewport.js.map