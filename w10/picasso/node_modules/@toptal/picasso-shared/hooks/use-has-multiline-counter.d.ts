 ...
 */
export declare const useHasMultilineCounter: (name: string | undefined, hasCounter: boolean | undefined, setHasMultilineCounter?: ((name: string, hasCounter: boolean) => void) | undefined) => void;
